...
import ocmc from '../images/ocmc.png'
        ...
        <>
            <div className='sticky flex flex-col items-center w-screen min-h-screen pt-48 pb-24 bg-port-dark text-port-light'>
                ...
                <div className='flex flex-col w-[60vw]'>
                    <ProjectPreview name="OCMC Portal" isWinner={false} colour="bg-yellow-700" image={ocmc} link={"https://www.ontariocmc.ca/"}/>
                    ...
                    <ProjectPreview name="Poogatype" isWinner={false} colour="bg-indigo-800" image={poogatype} link={"https://poogatype.web.app/"}/>
                </div>
            </div>
